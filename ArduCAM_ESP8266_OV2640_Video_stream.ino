...
#define ARDUCAM_BUFFER_SIZE 2048
#if !(defined ESP8266 )
...
const char *AP_ssid = "AP_NITIN"; 
//Default is no password.If you want to set password,put your password here
const char *AP_password = "1234567890";

//Station mode you should put your ssid and password
const char *ssid = "Myelin_Innovation"; // Put your SSID here
const char *password = "K4hvdQ9tj9"; // Put your PASSWORD here
...
void camCapture(ArduCAM myCAM){
  ...
  static const size_t bufferSize = ARDUCAM_BUFFER_SIZE;
...
void setup() {
  ...
  myCAM.InitCAM();
  myCAM.OV2640_set_JPEG_size(OV2640_176x144);//(OV2640_320x240);
  myCAM.clear_fifo_flag();
